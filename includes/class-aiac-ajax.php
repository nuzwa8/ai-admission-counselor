...
class AIAC_AJAX {
    public function __construct() {
        ...
        add_action('wp_ajax_aiac_get_courses', array($this, 'get_courses'));
        add_action('wp_ajax_aiac_save_course', array($this, 'save_course'));
        add_action('wp_ajax_aiac_delete_course', array($this, 'delete_course'));
    }
    ...
    public function save_course() {
        ...
        $db = new AIAC_DB();
        $result = $db->save_course($data, $course_id);
    ...
    public function delete_course() {
        ...
        if ($result) {
            ...
            wp_send_json_error('Could not delete course');
        }
    }
}
new AIAC_AJAX();
